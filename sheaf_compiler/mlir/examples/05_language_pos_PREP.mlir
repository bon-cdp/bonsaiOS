module @language_model_pos_PREP {
  // Forward pass: Character decomposition + Wreath product attention
  func.func @predict_next_token(%input: tensor<4xf32>) -> f32 {
    ...
    %w0 = arith.constant 0.440928 : f32
    %w1 = arith.constant 0.051812 : f32
    %w2 = arith.constant 0.386016 : f32
    %w3 = arith.constant 0.051811 : f32
