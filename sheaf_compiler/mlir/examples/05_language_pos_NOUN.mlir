module @language_model_pos_NOUN {
  ...
  func.func @predict_next_token(%input: tensor<4xf32>) -> f32 {
    ...
    %w0 = arith.constant 0.156534 : f32
    %w1 = arith.constant 0.154101 : f32
    %w2 = arith.constant 0.063532 : f32
    %w3 = arith.constant 0.154088 : f32
