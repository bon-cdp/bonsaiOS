module @nse_nse_right {
  ...
  func.func @evolve(%input: tensor<20xf32>) -> f32 {
    ...
    %w0 = arith.constant 0.030431 : f32
    %w1 = arith.constant 0.050216 : f32
    %w2 = arith.constant 0.001375 : f32
    %w3 = arith.constant 0.000304 : f32
    %w4 = arith.constant 0.000327 : f32
    %w5 = arith.constant 0.000297 : f32
    %w6 = arith.constant 0.000269 : f32
    %w7 = arith.constant 0.000249 : f32
