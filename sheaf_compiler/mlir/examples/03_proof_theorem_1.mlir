module @proof_task_theorem_1 {
  // Forward pass: Character decomposition + Wreath product attention
  func.func @prove(%input: tensor<4xf32>) -> f32 {
    ...
    %w0 = arith.constant 0.705856 : f32
    %w1 = arith.constant 0.315656 : f32
    %w2 = arith.constant 0.235291 : f32
    %w3 = arith.constant 0.315654 : f32
