module @proof_task_theorem_0 {
  ...
  func.func @prove(%input: tensor<4xf32>) -> f32 {
    ...
    %w0 = arith.constant 0.428568 : f32
    %w1 = arith.constant 0.202031 : f32
    %w2 = arith.constant 0.142861 : f32
    %w3 = arith.constant 0.202031 : f32
