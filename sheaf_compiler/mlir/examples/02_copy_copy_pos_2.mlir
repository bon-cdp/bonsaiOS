module @copy_task_copy_pos_2 {
  ...
  func.func @predict(%input: tensor<4xf32>) -> f32 {
    ...
    %w0 = arith.constant 0.250001 : f32
    %w1 = arith.constant 0.250000 : f32
    %w2 = arith.constant 0.250000 : f32
    %w3 = arith.constant 0.249999 : f32
